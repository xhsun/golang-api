...
func withEmployeesID(id int) employeesOption {
...
func (m *EmployeesMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *EmployeesMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
...
func (m *EmployeesMutation) SetGender(s string) {
	m.gender = &s
}

// Gender returns the value of the "gender" field in the mutation.
func (m *EmployeesMutation) Gender() (r string, exists bool) {
	v := m.gender
	if v == nil {
		return
	}
...
func (m *EmployeesMutation) OldGender(ctx context.Context) (v string, err error) {
